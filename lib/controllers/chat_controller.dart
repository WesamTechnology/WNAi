...
import 'package:news_app/models/ai_model.dart';
import 'package:news_app/models/chat_session.dart';
import 'package:news_app/models/message_model.dart';
import 'package:news_app/services/ai_service.dart';
...
class ChatController extends GetxController {
  ...
  void _loadSessionsFromStorage() {
    ...
    if (storedSessions != null) {
      sessions.value =
          storedSessions.map((e) => ChatSession.fromJson(e)).toList();
    }
  }
  ...
  Future<void> sendMessage(String text) async {
    ...
    if (replyToMessage.value != null) {
      ...
      finalPrompt =
          "Context: I am replying to this message: \"${replyToMessage.value!.text}\".\nMy Reply: $text";
    }
    ...
    final userMessage = Message(
      ...
      replyToText:
          replyToMessage.value?.text, // We need to add this field to model
    );

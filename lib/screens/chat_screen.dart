...
import 'package:news_app/widget/chat_history_drawer.dart';
                ...
                child: ListView(
                  ...
                  children:
                      AIModels.availableModels.map((model) {
                        return Obx(() {
                          final isSelected =
                              controller.currentModel.value.id == model.id;
                          return ListTile(
                            leading: Text(
                              model.iconAsset,
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Column(
                            children: [
                              Text(
                                controller.currentModel.value.iconAsset,
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    controller.replyToMessage.value!.isUser
                        ? "Replying to You"
                        : "Replying to AI",
                    style: TextStyle(
                      color: Theme.of(context).colorScheme.primary,
